...
export const diamondLoupeAbi = [
  ...
  },
  {
    ...
    inputs: [{ name: "facet", type: "address", internalType: "address" }],
    outputs: [{ name: "facetFunctionSelectors_", type: "bytes4[]", internalType: "bytes4[]" }],
    stateMutability: "view",
  },
  {
    type: "function",
